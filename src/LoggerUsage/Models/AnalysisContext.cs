...
public class AnalysisContext
{
    ...
    public static AnalysisContext CreateForWorkspace(
        LoggingTypes loggingTypes,
        SyntaxNode root,
        SemanticModel semanticModel,
        Solution solution,
        ILogger? logger = null)
    {
        return new AnalysisContext(loggingTypes, root, semanticModel, solution, logger);
    }
    ...
    public static AnalysisContext CreateForCompilation(
        LoggingTypes loggingTypes,
        SyntaxNode root,
        SemanticModel semanticModel,
        ILogger? logger = null)
    {
        return new AnalysisContext(loggingTypes, root, semanticModel, null, logger);
    }
}